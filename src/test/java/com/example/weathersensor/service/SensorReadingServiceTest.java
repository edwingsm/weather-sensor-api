...
class SensorReadingServiceTest {
    ...
    void shouldGetAverageMetricsForAllSensors() {
        ...
        Optional<AverageMetricsDto> mockResult = Optional.of(new AverageMetricsDto(25.5, 65.0, 15.0D, 10L)); //{25.5, 65.0, 15.0, 10L};
        when(repository.findAverageMetricsInDateRangeV2(any(Instant.class), any(Instant.class)))
